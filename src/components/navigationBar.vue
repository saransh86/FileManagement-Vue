            ...
            <md-app-toolbar class="md-primary "> 
                ...
                <div class="md-toolbar-section-end">
                    <div class="md-layout-item">
                        <div class="searchBar">
                            <vue-select :key="componentkey" placeholder="Search Files" @input="setSelected" :clearable="false" label="fileName" v-model="selected" :options="this.allFiles" ></vue-select>
                        </div>
                    </div>
                    <userOptions/>
                </div>
